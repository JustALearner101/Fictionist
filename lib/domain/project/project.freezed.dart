...
mixin _$Project {
  ...
  int get hashCode => Object.hash(runtimeType, id, name, description,
      coverImagePath, lastAccessedAt, createdAt, updatedAt, isDeleted);

  @override
  String toString() {
    return 'Project(id: $id, name: $name, description: $description, coverImagePath: $coverImagePath, lastAccessedAt: $lastAccessedAt, createdAt: $createdAt, updatedAt: $updatedAt, isDeleted: $isDeleted)';
  }
}
