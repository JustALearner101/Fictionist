...
mixin _$SearchResult {
  ...
  @override
  int get hashCode => Object.hash(runtimeType, entity, snippet);

  @override
  String toString() {
    return 'SearchResult(entity: $entity, snippet: $snippet)';
  }
}
...
abstract mixin class $SearchResultCopyWith<$Res> {
  ...
  @useResult
  $Res call({Entity entity, String snippet});
...
extension SearchResultPatterns on SearchResult {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(Entity entity, String snippet)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _SearchResult() when $default != null:
        return $default(_that.entity, _that.snippet);
      case _:
        return orElse();
    }
  }
...
class _SearchResult implements SearchResult {
  const _SearchResult({required this.entity, required this.snippet});
